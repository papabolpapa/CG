...
float intCol[3] = {1.0,1.0,1.0};  //White col
float fillCol[3] = {1.0,0.0,0.0}; //Flood Fill  //Red col
float fillColor[3]={0.0,0.0,1.0}; //boundary Fill  //Blue col
float borderColor[3]={1.0,0.0,0.0}; //Red col
...
void keyboard(unsigned char key,int x,int y)
{
    switch(key)
    {
        case 'f':
            ...
            glColor3f(0.0,0.0,0.0);  //black color border of polygon.
...
int main(int argc, char** argv)
{
    ...
    glutCreateWindow("Flood-Fill and Boundary-Fill [Dhiraj SIA09]");
    myinit();
